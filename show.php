...
<?php
$conn = mysqli_init();
mysqli_real_connect($conn, 'prettyhigh.mysql.database.azure.com', 'visal@prettyhigh', 'NWTkgl78', 'itflab', 3306);
...
<br>
<div class="container">
    <table class = "table table-dark table-hover" width="1200" align="center" border="1">
